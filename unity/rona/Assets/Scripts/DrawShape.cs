...
public class DrawShape : MonoBehaviour
{
    ...
    void DrawPolygon2D(Vector2[] vertices, ushort[] triangles, Color color)
    {
        ...
        EdgeCollider2D edgeCollider2D = polygon.AddComponent<EdgeCollider2D>();
        edgeCollider2D.points = new Vector2[] { new Vector2(0, 1.1f), new Vector2(1, 1.8f), new Vector2(1.9f, 1.1f) };
